  ...
  return (
    <div className="relative w-full">
      <input
        ...
        id={name}
        name={name}
        className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-500 appearance-none    focus:outline-none focus:ring-0 focus:border-blue-600 peer border"
        placeholder=" "
        required
        min={min}
        max={max}
